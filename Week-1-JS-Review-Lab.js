...
const listing1 = {...listings, isSold: false, currentOwner: "Jane Doe"};
...
const newBuiltListings = listings.filter((newBuiltListings) => newBuiltListings.builtIn.includes("1990"));
